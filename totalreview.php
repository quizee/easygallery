...
var del_comment = function(element){
  ...
  $.ajax({
      ...
      success : function(data) {
        ...
        $('#comment_text').val('');
        //alert(data);
        var comment_num = $('#comment_div').children().length;
        $('#comment_count').val(comment_num);
  ...
  //댓글을 하나 게시했을 때
    ...
    $('#comment_is').click(function(){
        if($(this).html()=="접기"){
          ...
          var comment_num = $('#comment_count').val();
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              ...
              <input type="hidden" name="comment_count" id="comment_count" value="">
              <br>
            </div>
          </div>
          <div class="row">
