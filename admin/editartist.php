...
<div class="content">
  <div class="container-fluid">
    ...
    $get_artist = "select * from artists where artist_id=$artist_id;";
    $result = mysqli_query($conn,$get_artist);
        ...
        <div class="col-md-6">
          <form method="post" id="art_frm" name="art_frm" action="" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <input type="text" value="<?php echo $row['artist_name']; ?>" class="form-control" id="artist_name" name="artist_name" required="작가명을 입력해주세요">
            </div>
            <div class="form-group">
              <h4>작가 소개</h4>
              <textarea name="artist_introduce" rows="10" form="art_frm" class= "md-textarea form-control" required wrap="hard" placeholder="작가의 소개글을 남겨주세요"cols="80"><?php echo $row['artist_introduce']; ?></textarea>
            </div>
            <div class="form-group">
              <h4>작가 경력</h4>
              <textarea name="carrier" rows="10" form="art_frm" class= "md-textarea form-control" required wrap="hard" cols="80"><?php echo $row['carrier']; ?></textarea>
            </div>
            <div class="form-group">
              <label for="art_size">작가 활동시기:</label>
              <div class="input-group" id="art_size">
                <label for="horizontal" class="mr-2">출생년도</label>
                <input type="text" value="<?php echo $row['birth']; ?>" class="form-control" onkeypress="validate(event)" id="horizontal" name="birth"required>
                <label for="vertical" class="ml-2 mr-2">사망년도</label>
                <input type="text" value = "<?php if($row['death']==NULL){echo "";}else{ echo $row['death']; }?>" class="form-control" id="vertical" onkeypress="validate(event)" name="death" placeholder="생존시 빈칸으로">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="input-group" id="art_photo">
                <div class="custom-file">
                  <input id="file_name" class="form-control readonly" name="file_name" value="<?php echo $row['artist_photo']; ?>" style="display:inline;">
              ...
              <div class="selectCover">
                <img id="cover" src="<?php echo '../database/artists/'.$row['artist_photo']; ?>" style="width: 100%; height: 500px;"/>
              </div>
            </div>
